...
const config = {
      ...
      '@docusaurus/plugin-content-docs',
      {
        ...
        sidebarPath: './docs-sdk/sidebar.js',
  ...
  ],
            {
              ...
              fullContent: true,
              title: 'Vantage SDK Documentation',
              description: 'Documentation for Vantage SDK'
            },
            {
              ...
              fullContent: true,
              title: 'Vantage Platform Documentation',
              description: 'Documentation for Vantage Platform'
            },
          ],
        },
    ],
  ...
  themeConfig: {
    navbar: {
      title: `Vantage Compute Documentation v2.3.0`,
      logo: {
      ...
      items: [
        {
          ...
          label: 'Vantage Compute Documentation',
          position: 'center',
          //className: 'github',
        },
      ],
...
module.exports = async function createConfigAsync() {
  return {
    ...
    // Removed themes section - using Algolia search instead
