...
The detail page has a <kbd>Deploy</kbd> button. It opens the [Endpoints](/platform/workbench/endpoints) wizard pre-filled with this model as the source — the most common path to production.
...
- [Registering a model](/platform/workbench/models/registering-a-model)
- [Reference](/platform/workbench/models/reference)
