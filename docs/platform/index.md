  ...
  <div className="col col--6 margin-bottom--lg">
    <div className="card">
      ...
      <div className="card__body text--center">
        ...
        <a href="/platform/workbench/sessions/remote-desktops/" className="button button--primary">Learn More</a>
      </div>
    </div>
  </div>
  <div className="col col--6 margin-bottom--lg">
    <div className="card">
      ...
      <div className="card__body text--center">
        ...
        <a href="/platform/workbench/sessions/notebooks/" className="button button--primary">Learn More</a>
      </div>
    </div>
  </div>
  <div className="col col--6 margin-bottom--lg">
