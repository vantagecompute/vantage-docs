...
The detail page has a <kbd>Deploy</kbd> button. It opens the [Endpoints](../endpoints) wizard pre-filled with this model as the source — the most common path to production.
